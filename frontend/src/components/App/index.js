...
class App extends React.Component {
  ...
  logout() {
    ...
    //   history.push(
    //     process.env.REACT_APP_SUB_PATH.replace("http://", "") + "/login"
    //   );
    // } else
  }
  ...
  render() {
    ...
    return (
      <BrowserRouter
        history={history}
        basename={process.env.REACT_APP_SUB_PATH.replace("http://", "")}
      >
        <div>
          {currentUser && (
            <nav className="navbar navbar-expand navbar-dark bg-dark">
              <div className="navbar-nav">
                ...
                <Link to="/script" className="nav-item nav-link">
                  Scripts
                </Link>
                {this.state.currentUser &&
                this.state.currentUser.roles.filter((role) => {
                ...
                <Link to="/application" className="nav-item nav-link">
                  Applications
                </Link>
